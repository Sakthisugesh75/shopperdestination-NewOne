    ...
    <div class="breadcrumb-wrapper breadcrumb-wrapper-2 breadcrumb-contacts">
        ...
        <div>
            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                data-bs-target="#addUser"> Add Sub Category
            </button>
        </div>
                    ...
                    <form action="#" id="addform" method="POST">
                        ...
                        <div class="form-group row">
                            <div class="form-group mb-4">
                                ...
                                <select type="text" name="category" class="form-select" placeholder="Enter role" id="category" >
                   ...
                   <form action="#" id="form" method="POST">
                    ...
                    <input type="hidden" name="u_id" id="u_id">
                       ...
                       <div class="form-group row">
                        <div class="form-group mb-4">
                            <label for="event">Category</label>
                            <select type="text" name="u_category" class="form-select" placeholder="Enter role" id="u_category" >
                                <option value="">Select Category</option>
                                <?php
       ...
       .then(data => {
        ...
        $("#save_button_loading").hide();
           if (data.status == 'SUCCESS') {
               // console.log(data);
               Swal.fire({
            title: 'Sub_category Added Successfully',
            icon: 'success',
...
e.preventDefault();
    ...
    $.ajax({
                type:'GET',
                url:'<?php echo url('/');?>/api/v1/sub_category/list-sub_category-ById',
                data:{'id': id},
                success:function(data) {
                    ...
                    if(data.status =="SUCCESS"){
                        ...
                        $('#u_cat_name').val(data.list.sub_category_name);
                        $('#u_slug').val(data.list.slug);
                        $('#u_category').val(data.list.category_id);
       ...
       .then(data => {
        ...
        $("#save_button_loading").hide();
           if (data.status == 'SUCCESS') {
               // console.log(data);
               Swal.fire({
            title: 'Sub_category Updated Successfully',
            icon: 'success',
            confirmButtonColor: '#3085d6',
            confirmButtonText: 'Ok'
            }).then((result) => {
