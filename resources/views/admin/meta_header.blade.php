...
<head>
	...
	<meta name="description" content="Wakuda - Admin Dashboard ">

	<title>Shoppers Destination  - Admin Dashboard.</title>
	...
	<!-- FAVICON -->
	<link href="{{url ('frontassets/images/logo/apple-touch-icon.png') }}" rel="shortcut icon" />
