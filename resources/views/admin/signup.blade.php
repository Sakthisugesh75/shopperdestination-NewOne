...
<head>
  ...
  <!-- Ekka CSS -->
  <link id="ekka-css" rel="stylesheet" href="{{url ('assets/css/style.css') }}" />

  <!-- FAVICON -->
  <link href="{{url ('assets/img/apple-touch-icon.png')}}" rel="shortcut icon" />
</head>
          ...
          <div class="card-header bg-primary">
            <div class="ec-brand">
              <a href="index.html" title="Ekka">
                <img class="ec-brand-icon" src="{{url ('assets/img/logo/logo-login.png') }}" alt="" />
              </a>
            </div>
          </div>
