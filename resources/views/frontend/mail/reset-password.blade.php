...
<head>
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 600px) {
            ...
            .steps-box { padding: 20px !important; }
        }
    </style>
</head>
        ...
        <tr>
            <td align="center" style="padding: 40px 20px;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="email-container" style="max-width: 600px; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 10px 40px rgba(102, 126, 234, 0.1);">
                    ...
                    <!-- Content -->
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 48px 24px;">
                            <p style="margin: 0 0 24px; font-size: 15px; color: #555555; line-height: 1.7;">
                                After you click the button below, you'll be asked to complete the following steps:
                            </p>
                            
                            <!-- Steps Box -->
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td class="steps-box" style="background: linear-gradient(135deg, #f8f9ff 0%, #f0f2ff 100%); border-radius: 16px; padding: 28px; border-left: 4px solid #667eea;">
                                        
                                        <!-- Step 1 -->
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 16px;">
                                            <tr>
                                                <td width="36" style="vertical-align: top;">
                                                    <div style="width: 28px; height: 28px; background: linear-gradient(135deg, #667eea, #764ba2); border-radius: 50%; color: #fff; font-size: 14px; font-weight: 600; text-align: center; line-height: 28px;">1</div>
                                                </td>
                                                <td style="padding-left: 12px; font-size: 15px; color: #333333; line-height: 28px;">
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 16px;">
                                            <tr>
                                                <td width="36" style="vertical-align: top;">
                                                    <div style="width: 28px; height: 28px; background: linear-gradient(135deg, #667eea, #764ba2); border-radius: 50%; color: #fff; font-size: 14px; font-weight: 600; text-align: center; line-height: 28px;">2</div>
                                                </td>
                                                <td style="padding-left: 12px; font-size: 15px; color: #333333; line-height: 28px;">
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td width="36" style="vertical-align: top;">
                                                    <div style="width: 28px; height: 28px; background: linear-gradient(135deg, #667eea, #764ba2); border-radius: 50%; color: #fff; font-size: 14px; font-weight: 600; text-align: center; line-height: 28px;">3</div>
                                                </td>
                                                <td style="padding-left: 12px; font-size: 15px; color: #333333; line-height: 28px;">
                                                    Click Submit
                                                </td>
                    ...
                    <!-- CTA Button -->
                    <tr>
                        <td class="mobile-padding" style="padding: 16px 48px 24px; text-align: center;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
                                <tr>
                                    <td style="border-radius: 50px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                                        <a href="{{ $details['reset_url'] }}" target="_blank" style="display: inline-block; padding: 18px 48px; font-size: 16px; font-weight: 600; color: #ffffff; text-decoration: none; letter-spacing: 0.5px; text-transform: uppercase;">
                                            Reset Your Password
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <!-- Expiry Warning -->
                    <tr>
                        <td class="mobile-padding" style="padding: 0 48px 24px;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td style="background-color: #fff8e6; border-radius: 12px; padding: 16px 20px; text-align: center;">
                                        <p style="margin: 0; font-size: 14px; color: #996600; line-height: 1.5;">
                                            ⏱️ <strong>This link is valid for one use only.</strong> Expires in 2 hours.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <!-- Safety Note -->
                    <tr>
                        <td class="mobile-padding" style="padding: 0 48px 32px;">
