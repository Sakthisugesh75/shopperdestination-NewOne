...
class Mcity extends Model
{
  ...
  public function getallCity(){
    ...
    ->select('city.*','state.state_name as state_name','country.country_name as country_name')
    ->where('city.status',"1")
    ->orderBy('city.city_id', 'DESC')->limit(1000)->get()->toArray();
    return $item;
  }
  ...
  public function getcitybystate($state_id){
    $this->city->select('*');
    $this->city->where('state_id', $state_id);
    $item=$this->city->get()->toArray();
    return $item;
  }
